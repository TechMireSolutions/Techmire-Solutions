        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 pb-16 border-b border-white/[0.05]">
          ...
          <div>
            ...
            <address className="not-italic space-y-2.5 text-white/30 text-[12.5px] leading-relaxed font-light">
              ...
              <a href="tel:+923172225152" className="block hover:text-white transition-colors mt-3">(+92) 317 222 5152</a>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {SERVICES.map(i => (
                <li key={i.h}>
                  <Link href={i.h} className="text-white/30 text-[12.5px] hover:text-white transition-colors font-light">{i.l}</Link>
                </li>
              ))}
            </ul>
          </div>
